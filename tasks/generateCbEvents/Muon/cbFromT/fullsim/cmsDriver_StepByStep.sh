...
#Common parameters
fragment="Configuration/GenProduction/python/ttbar_cbFromT_Muon_fragment.py"
...
cp ./ttbar_cbFromT_Muon_fragment.py $CMSSW_BASE/src/Configuration/GenProduction/python
cd $CMSSW_BASE/src
scram b
cd $here
