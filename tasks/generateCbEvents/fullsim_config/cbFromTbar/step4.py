...
# with command line options: --python_filename step4.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RAW --fileout file:step4.root --conditions 102X_upgrade2018_realistic_v15 --step HLT:2018v32 --filein file:step3.root --era Run2_2018 --no_exec --mc -n 400 --customise_commands process.source.bypassVersionCheck = cms.untracked.bool(True)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('--python_filename nevts:400'),
