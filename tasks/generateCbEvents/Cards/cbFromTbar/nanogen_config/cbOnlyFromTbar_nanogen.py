...
# with command line options: Configuration/GenProduction/python/ttbar_cbFromTbar_fragment.py --fileout file:cbOnlyFromTbar_nanogen.root --mc --eventcontent NANOAODGEN --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename cbOnlyFromTbar_nanogen.py -n 1000 --no_exec --nThreads=1
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/ttbar_cbFromTbar_fragment.py nevts:1000'),
...
process.NANOAODGENoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:cbOnlyFromTbar_nanogen.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('root://eosuser.cern.ch//eos/user/p/pviscone/Vcb_ditopDecay/tasks/generateCbEvents/Cards/cbFromTbar/ttbar_semilept_cbOnlyFromTbar_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
