...
# with command line options: Configuration/GenProduction/python/ttbar_cbFromT_fragment.py --fileout file:cbOnlyFromT_nanogen.root --mc --eventcontent NANOAODGEN --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename cbOnlyFromT_nanogen.py -n 1000 --no_exec --nThreads=1
