...
signal_score=torch.exp(model(test_dataset.mu_data[signal_mask],test_dataset.nu_data[signal_mask],test_dataset.jet_data[signal_mask])[:,-1])
bkg_score=torch.exp(model(test_dataset.mu_data[bkg_mask],test_dataset.nu_data[bkg_mask],test_dataset.jet_data[bkg_mask])[:,-1])
...
signal_hist,bin_edges=np.histogram(signal_score,bins=bins,range=(0,1))
bkg_hist,_=np.histogram(bkg_score,bins=bins,range=(0,1))
