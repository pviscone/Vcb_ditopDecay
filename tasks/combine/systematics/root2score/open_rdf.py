...
def build_rdf_dict(sample_dict,bunch_size=10):
    ...
    for sample in sample_dict:
        ...
        if sample=="bkg":
            ...
            weight_dict["Muons"]["semiLept"]=sample_dict[sample]["Muons_weight"]
            weight_dict["Electrons"]["semiLept"]=sample_dict[sample]["Electrons_weight"]
            weight_dict["Muons"]["semiLeptTau"]=sample_dict[sample]["Muons_weight"]
            weight_dict["Electrons"]["semiLeptTau"]=sample_dict[sample]["Electrons_weight"]
        else:
